      ...
      {PROJECTS.map((project, index) =>
        project.url === "haylur-organics" ? (
          <div
            ...
            <div className="overflow-hidden flex justify-center items-center absolute top-[15%] max-lg:top-[30%] max-sm:top-[15%] max-[450px]:top-[12%] pointer-events-none w-full">
