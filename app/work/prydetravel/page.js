  ...
  return (
    <section className=" bg-black text-white p-3">
      ...
      {PROJECTS.map((project, index) =>
        project.url === "prydetravel" ? (
          <div
            key={index}
            className=" flex justify-center items-center flex-col">
            <img
              src={project.bg}
              className=" max-w-4xl w-full cursor-pointer relative pt-28 opacity-90"
            />
            ...
            <div className=" text-white flex justify-between items-start w-full  max-w-4xl py-16 max-md:flex-col max-md:gap-5 max-md:text-center">
              ...
              <p className=" text-xl max-w-md text-justify max-md:m-auto max-md:text-center">
                {project.description}
              </p>
            </div>
