    ...
    <main
      ...
      <section
        ...
        <div className="word-container h-full cursor-default max-lg:hidden flex justify-center items-start flex-col">
          <motion.div
            ...
            <h1 className="word font-Betatron text-[300px] max-xl:text-[250px] leading-[0.8] duration-500">
              ASSEM
              <br />
              <span className="text-stroke">ECOM</span>
            </h1>
          </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0 }}>
          <Link
            href="https://calendly.com/assem-ecom/30min"
            className=" flex justify-center items-center ">
            <h2
              className=" animate-scrolling-text font-Betatron text-5xl font-bold"
              style={{ writingMode: "vertical-lr" }}>
              BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL : START A
              PROJECT : BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL :
              BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL : START A
              PROJECT : BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL :
              BOOK A FREE CALL : BOOK A FREE CALL : START A PROJECT : BOOK A
              FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL
              : BOOK A FREE CALL : BOOK A FREE CALL : START A PROJECT : BOOK A
              FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL
              : BOOK A FREE CALL : BOOK A FREE CALL : START A PROJECT : BOOK A
              FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL : BOOK A FREE CALL
      ...
      <section className="max-2xl px-8 my-28 flex justify-center items-center flex-col gap-10 pb-60 max-sm:px-3">
        ...
        <motion.p
          ...
          We make ecom stores
          <br /> aesthetic, functional & turn them into money machines for you.
        </motion.p>
      </section>
        ...
        <div className=" flex w-full flex-col" ref={scrollRef7}>
          {PROJECTS.map((project, index) => (
            <div key={index}>
              ...
              <div
                className={` project-bg${index} fixed max-w-2xl right-10 max-sm:right-0`}>
                <img
                  src={project.bg}
      ...
      <section className="max-2xl px-8 mt-28">
        ...
        <motion.div
          ...
          <Link
            ...
            <span className="text-stroke">BOOK </span>A <br /> FREE
            <span className="text-stroke"> CALL</span>
          </Link>
        </motion.div>
        ...
        <div className="flex justify-between max-[500px]:flex-col max-[500px]:text-center">
          ...
          <ul className=" flex justify-center items-center gap-5 text-xs mr-32 max-lg:mr-0 max-[500px]:mb-5">
            <a
              href="https://www.instagram.com/assem.ecom.webdev/"
              target="_blank"
